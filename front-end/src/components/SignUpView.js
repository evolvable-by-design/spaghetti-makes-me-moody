...
class SignUpView extends React.Component {
  ...
  userSignUp() {
    var object = this
    this.props.spaghettiService.createUser(
  ...
  handlePasswordRChange(event) {
    ...
    promise.then(
      function(result) {
        if (
          passSchema.validate(object.state.passwordRField) &&
          object.state.passwordField === object.state.passwordRField
        ) {
    ...
    return (
      <div>
        ...
        <div class="SignUpFieldsVerticalLayoutStyle">
          ...
          <label for="psw-repeat" class="SignUpBodyText">
            <b>repeat password</b>
          </label>
          <div class="SignUpFieldsHoriztonalLayoutStyle">
            <input
